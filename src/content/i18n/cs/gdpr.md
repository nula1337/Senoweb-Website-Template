  ...
  gdpr:
    ...
    items:
        ...
        - heading: Správce osobních údajů
          text: Správcem osobních údajů je {{client.name}}, se sídlem {{client.address.lineOne}}, {{client.address.zip}} {{client.address.city}}, IČO {{client.ico}} a jako správce zpracováváme tyto vaše osobní údaje - jméno, příjmení, email a telefonní číslo.
