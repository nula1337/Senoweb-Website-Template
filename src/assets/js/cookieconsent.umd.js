	...
	(t = function (e) {
		...
		const Q = (e) => {
			...
			be = (e, t) => {
				...
				(b && ((n.Re.innerHTML = b), v && A(n.Be, "aria-label", v)),
							...
							if ((L(D, "section-title-wrapper"), L(k, "section-title"), (k.innerHTML = s), V(D, k), b)) {
								...
								if (T > 0 && h(o)) {
									...
									(L(e, "badge"),
										...
										o && ((o = o.split("|")), (o = o.length > 1 && T > 1 ? o[1] : o[0]), A(e, "data-counterlabel", o)),
										(e.innerHTML = T + (o ? " " + o : "")),
										V(k, e));
								}
								if (w) {
					...
					y &&
						(n.ze || ((n.ze = E(i)), L(n.ze, "btn"), A(n.ze, _, "all"), V(k, n.ze), B(n.ze, f, () => u("all"))),
						(n.ze.innerHTML = y)),
					w &&
						(n.Le || ((n.Le = E(i)), L(n.Le, "btn"), A(n.Le, _, "necessary"), V(k, n.Le), B(n.Le, f, () => u([]))),
						(n.Le.innerHTML = w)),
					x &&
						(n.qe ||
							((n.qe = E(i)),
		...
		const ye = () => {
			...
			he = (e, t) => {
				...
				w &&
					(n.Ze || ((n.Ze = E("h2")), (n.Ze.className = n.Ze.id = "cm__title"), V(n.Xe, n.Ze)), (n.Ze.innerHTML = w));
				let x = p.description;
				if (
					(x &&
					...
					n.ot &&
						!n.st &&
						((n.st = E(r)),
						n.je && n.tt ? (I(n.st, d), V(n.st, n.ot), V(n.Ye, n.st)) : (V(n.nt, n.ot), I(n.nt, d + "--uneven"))),
					h)
				) {
					if (!n.ct) {
						let e = E(r),
			...
			Ae = (e, t, o) => {
				...
				const n = o || m.t.cookie.domain,
					...
					r = (e, t) => {
						(t && "." !== t.slice(0, 1) && (t = "." + t),
							(document.cookie =
								e + "=; path=" + s + (t ? "; domain=" + t : "") + "; expires=Thu, 01 Jan 1970 00:00:01 GMT;"));
					};
					...
					if (
						...
						((e) => {
							...
							(g === o && (a.mode = g),
								...
								!0 === a.hideFromBots &&
									u &&
									(r.G = (u.userAgent && /bot|crawl|spider|slurp|teoma/i.test(u.userAgent)) || u.webdriver),
								C(d) && (a.cookie = { ...i, ...d }),
								a.autoClearCookies,
								r.V,
								a.manageScriptTags,
