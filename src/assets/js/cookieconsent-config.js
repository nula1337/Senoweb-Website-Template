		...
		translations: {
			cs: {
				consentModal: {
					...
					description:
						"Náš web používá cookies pro zlepšení vašeho zážitku z prohlížení, analýzu návštěvnosti a další funkce.",
				...
				preferencesModal: {
					...
					sections: [
						...
						},
						{
							...
							description:
								"Tyto cookies shromažďují informace o tom, jak používáte náš web. Všechna data jsou anonymizována a nemohou být použita k vaší identifikaci.",
							linkedCategory: "analytics"
						},
						{
							title: "Další informace",
							description:
								'V případě jakýchkoli dotazů ohledně našich zásad používání cookies a vašich možností nás prosím <a href="/kontakt">kontaktujte</a>'
						}
					]
				}
			}
